      ...
      <Card className="p-8 rounded-none rounded-tr-4xl ">
        ...
        <CardContent>
          <p className="text-4xl font-bold">
            Senior{" "}
            <span className="inline-block bg-[#78cc6d] rounded-full p-2 -rotate-4 origin-bottom-left text-black font-bold">
              Data Scientist{" "}
            </span>
            and Data Scientist Based in California, Los Angeles.
          </p>
        </CardContent>
